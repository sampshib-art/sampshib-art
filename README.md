...
## Featured 3D & Web Environments

> ### [Pranish Store →](https://pranishstore1.netlify.app/)
> A custom storefront built from scratch. Next.js App Router with category and sub-category routing, product detail pages, and scroll-driven motion throughout. No template, no theme.

> ### [Unseen Study →](https://sampuu.netlify.app/)
> A WebGL interaction study — canvas scene, drag-to-explore navigation, audio toggle, scroll-bound motion. Built to take apart how high-end WebGL sites handle scene loading, pointer input and motion timing. A recreation of `unseen.co` for study; the original design is theirs.
